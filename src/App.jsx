...
// ═══ LOGO (embedded) ═══════════════════════════════════════════════
import LOGO_B64 from "./redpen-logo.png";
...
function AboutPage(){
  return <div style={{maxWidth:"640px"}}>
    <div style={{marginBottom:"32px"}}>
      ...
      <h1 style={{fontSize:"30px",fontWeight:"600",letterSpacing:"-0.02em",lineHeight:1.2,margin:"0 0 14px"}}>RedPen.AI — The Editorial Writing Suite</h1>
...
function PricingPage(){
  return <div style={{maxWidth:"640px"}}>
    <div style={{marginBottom:"32px"}}>
      ...
      <h1 style={{fontSize:"30px",fontWeight:"600",letterSpacing:"-0.02em",lineHeight:1.2,margin:"0 0 14px"}}>All tools. No paywall.</h1>
    ...
    <div style={{marginBottom:"28px"}}>
      ...
      <p style={{fontSize:"14px",lineHeight:"1.75",color:"#44403C",marginBottom:"10px"}}>RedPen.AI runs inside Claude.ai as an artifact. This means:</p>
      {[
        ...
        "Usage is subject to Claude.ai's standard rate limits (generous for normal use)",
      ].map((item,i)=>(
...
function TipsPage(){
  ...
  return <div style={{maxWidth:"640px"}}>
    <div style={{marginBottom:"32px"}}>
      ...
      <h1 style={{fontSize:"30px",fontWeight:"600",letterSpacing:"-0.02em",lineHeight:1.2,margin:"0 0 14px"}}>Getting the most out of RedPen.AI</h1>
...
function FAQPage(){
  ...
  return <div style={{maxWidth:"640px"}}>
    <div style={{marginBottom:"32px"}}>
      ...
      <h1 style={{fontSize:"30px",fontWeight:"600",letterSpacing:"-0.02em",lineHeight:1.2,margin:"0 0 14px"}}>Frequently asked questions</h1>
...
export default function App(){
  ...
  const SB_W = sideOpen ? "200px" : "56px";
  ...
  return(
    <div style={{display:"flex",minHeight:"100vh",backgroundColor:"#FAF8F4",fontFamily:"'Lora',Georgia,serif",color:"#1C1917"}}>
      ...
      {/* ── SIDEBAR ── */}
      <div style={{width:SB_W,minHeight:"100vh",backgroundColor:"#0F0F0F",display:"flex",flexDirection:"column",flexShrink:0,transition:"width .2s ease",overflow:"hidden",position:"sticky",top:0,alignSelf:"flex-start",height:"100vh"}}>
        
        {/* Logo */}
        <div style={{padding:sideOpen?"18px 14px 10px":"10px 8px",borderBottom:"1px solid rgba(255,255,255,0.08)",display:"flex",alignItems:"center",gap:"8px",minHeight:"80px",flexShrink:0}}>
          <img src={LOGO_B64} alt="RedPen.AI" style={{width:sideOpen?"50px":"36px",height:"auto",flexShrink:0,transition:"width .2s"}} />
          {sideOpen&&<div>
            <div style={{fontSize:"15px",fontWeight:"700",color:"#FFFFFF",letterSpacing:"0.04em",lineHeight:1.1}}>REDPEN.AI</div>
            <div style={{fontSize:"9px",color:"#B91C1C",letterSpacing:"0.18em",textTransform:"uppercase",marginTop:"2px"}}>Editorial Suite</div>
          </div>}
        </div>

        {/* Tools section */}
        <div style={{padding:"12px 8px 4px",flexShrink:0}}>
          {sideOpen&&<div style={{fontSize:"9px",letterSpacing:"0.18em",textTransform:"uppercase",color:"rgba(255,255,255,0.3)",padding:"0 8px",marginBottom:"6px"}}>Tools</div>}
          {NAV_TOOLS.map(t=>{
            const active=mode===t.id;
            return <button key={t.id} className="nav-item" onClick={()=>{setMode(t.id);if(t.id!=="chat")reset();}}
              style={{width:"100%",padding:sideOpen?"8px 10px":"9px 0",display:"flex",alignItems:"center",gap:"10px",background:active?"rgba(185,28,28,0.25)":"transparent",border:"none",cursor:"pointer",borderRadius:"6px",marginBottom:"2px",justifyContent:sideOpen?"flex-start":"center",color:active?"#FF6B6B":"rgba(255,255,255,0.65)",fontFamily:"'Lora',Georgia,serif",transition:"background .15s,color .15s",borderLeft:active?"2px solid #B91C1C":"2px solid transparent"}}>
              <span style={{fontSize:"16px",flexShrink:0}}>{t.icon}</span>
              {sideOpen&&<span style={{fontSize:"13px",fontWeight:active?"600":"400",whiteSpace:"nowrap"}}>{t.label}</span>}
            </button>;
          })}
        </div>

        {/* Divider */}
        <div style={{height:"1px",backgroundColor:"rgba(255,255,255,0.08)",margin:"8px 12px",flexShrink:0}}/>

        {/* Info section */}
        <div style={{padding:"4px 8px",flexShrink:0}}>
          {sideOpen&&<div style={{fontSize:"9px",letterSpacing:"0.18em",textTransform:"uppercase",color:"rgba(255,255,255,0.3)",padding:"0 8px",marginBottom:"6px"}}>Info</div>}
          {NAV_INFO.map(t=>{
            const active=mode===t.id;
            return <button key={t.id} className="nav-item" onClick={()=>{setMode(t.id);}}
              style={{width:"100%",padding:sideOpen?"8px 10px":"9px 0",display:"flex",alignItems:"center",gap:"10px",background:active?"rgba(185,28,28,0.25)":"transparent",border:"none",cursor:"pointer",borderRadius:"6px",marginBottom:"2px",justifyContent:sideOpen?"flex-start":"center",color:active?"#FF6B6B":"rgba(255,255,255,0.65)",fontFamily:"'Lora',Georgia,serif",transition:"background .15s,color .15s",borderLeft:active?"2px solid #B91C1C":"2px solid transparent"}}>
        ...
        <div style={{padding:"12px 8px",borderTop:"1px solid rgba(255,255,255,0.08)",flexShrink:0}}>
          <button onClick={()=>setSideOpen(!sideOpen)} className="nav-item"
            style={{width:"100%",padding:"8px",display:"flex",alignItems:"center",justifyContent:sideOpen?"flex-end":"center",gap:"8px",background:"transparent",border:"none",cursor:"pointer",borderRadius:"6px",color:"rgba(255,255,255,0.4)",fontFamily:"'Lora',Georgia,serif",fontSize:"12px"}}>
            <span style={{fontSize:"16px",transform:sideOpen?"none":"rotate(180deg)",transition:"transform .2s"}}>‹</span>
          ...
          {mode==="chat"&&(
            <div>
              <div style={{marginBottom:"20px",borderBottom:"2px solid #1C1917",paddingBottom:"14px"}}>
                ...
                <h1 style={{fontSize:"24px",fontWeight:"600",letterSpacing:"-0.02em",margin:0}}>Writing Coach</h1>
              </div>
              ...
              <div style={{display:"flex",gap:"8px",alignItems:"flex-end",backgroundColor:"#FFF",border:"1.5px solid #E7E2D9",borderRadius:"8px",padding:"10px 12px"}}
                ...
                <textarea ref={chatInputRef} className="chat-ta" value={chatInput} onChange={e=>setChatInput(e.target.value)} onKeyDown={e=>{if(e.key==="Enter"&&!e.shiftKey){e.preventDefault();sendChat();}}} placeholder="Ask anything… (Enter to send, Shift+Enter for newline)" rows={2} style={{flex:1,border:"none",background:"none",fontSize:"14px",lineHeight:"1.6",fontFamily:"'Lora',Georgia,serif",color:"#1C1917",resize:"none",outline:"none",padding:0}}/>
